...
class Follower(models.Model):
    ...
    owner = models.ForeignKey(User, related_name='following', on_delete=models.CASCADE)  # noqa
    followed = models.ForeignKey(User, related_name='followed', on_delete=models.CASCADE)  # noqa
